...
describe DealsController do
  ...
  # DealsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deal as @deal" do
        ...
        post :create, {:deal => { "title" => "invalid value" }}, valid_session
        assigns(:deal).should be_a_new(Deal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deal" do
        ...
        Deal.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => deal.to_param, :deal => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deal as @deal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deal.any_instance.stub(:save).and_return(false)
        put :update, {:id => deal.to_param, :deal => { "title" => "invalid value" }}, valid_session
        assigns(:deal).should eq(deal)
      end
