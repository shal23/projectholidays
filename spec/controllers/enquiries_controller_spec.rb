  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved enquiry as @enquiry" do
        ...
        post :create, {:enquiry => { "name" => "invalid value" }}, valid_session
        assigns(:enquiry).should be_a_new(Enquiry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested enquiry" do
        ...
        Enquiry.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => enquiry.to_param, :enquiry => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the enquiry as @enquiry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Enquiry.any_instance.stub(:save).and_return(false)
        put :update, {:id => enquiry.to_param, :enquiry => { "name" => "invalid value" }}, valid_session
        assigns(:enquiry).should eq(enquiry)
      end
