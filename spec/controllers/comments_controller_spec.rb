  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comment" do
        ...
        Comment.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => comment.to_param, :comment => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the comment as @comment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Comment.any_instance.stub(:save).and_return(false)
        put :update, {:id => comment.to_param, :comment => { "name" => "invalid value" }}, valid_session
        assigns(:comment).should eq(comment)
      end
